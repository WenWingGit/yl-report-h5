...
export const standard = {
  accident: `<div class="content">1、本合同所指的“重大事故车”是指车辆结构部件受到一定程度的损伤且经过修复仍旧不能恢复全部性能的车辆的总称，具体判定规则标准如下：<br>2、事故车判定规则：<br>（1）车身结构部件检测项存在严重变形、严重钣金、切割、焊接、更换等维修经历或对应维修手段（指钣金、切割、焊接、更换）遗留的维修痕迹时，判定车辆存在事故风险；<br>（2）下表中任一检测项存在对应缺陷结果栏中的任何一项缺陷时，即判定为“重大事故车”，但“改装损伤”除外；<br>（3）针对车身结构件因改装发生状态改变的情况（仅限于改装打孔情况，且打孔直径≤3cm），该检测项将标记为“改装损伤”，存在改装损伤的车辆不定义为重大事故车，因改装进行过切割、焊接或改装部位发生变形、撕裂（包括打孔后孔眼撕裂）的，按照具体部位的对应标准执行。<br>注：不同部件/部位存在缺陷需要描述程度时，不同的部件/部位对“严重”的概念将予以单独标注，未予描述的则不区分缺陷的程度。</div>
  <img src="/shigu.jpg"/>`,
  soakInWater: `<div class="content">1、本合同所指的“重大事故车”是指车辆结构部件受到一定程度的损伤且经过修复仍旧不能恢复全部性能的车辆的总称，具体判定规则标准如下：<br>2、事故车判定规则：<br>（1）车身结构部件检测项存在严重变形、严重钣金、切割、焊接、更换等维修经历或对应维修手段（指钣金、切割、焊接、更换）遗留的维修痕迹时，判定车辆存在事故风险；<br>（2）下表中任一检测项存在对应缺陷结果栏中的任何一项缺陷时，即判定为“重大事故车”，但“改装损伤”除外；<br>（3）针对车身结构件因改装发生状态改变的情况（仅限于改装打孔情况，且打孔直径≤3cm），该检测项将标记为“改装损伤”，存在改装损伤的车辆不定义为重大事故车，因改装进行过切割、焊接或改装部位发生变形、撕裂（包括打孔后孔眼撕裂）的，按照具体部位的对应标准执行。<br>注：不同部件/部位存在缺陷需要描述程度时，不同的部件/部位对“严重”的概念将予以单独标注，未予描述的则不区分缺陷的程度。</div>
  <img src="/shigu.jpg"/>`,
  fire: `<div class="content">1、本合同所指的“重大事故车”是指车辆结构部件受到一定程度的损伤且经过修复仍旧不能恢复全部性能的车辆的总称，具体判定规则标准如下：<br>2、事故车判定规则：<br>（1）车身结构部件检测项存在严重变形、严重钣金、切割、焊接、更换等维修经历或对应维修手段（指钣金、切割、焊接、更换）遗留的维修痕迹时，判定车辆存在事故风险；<br>（2）下表中任一检测项存在对应缺陷结果栏中的任何一项缺陷时，即判定为“重大事故车”，但“改装损伤”除外；<br>（3）针对车身结构件因改装发生状态改变的情况（仅限于改装打孔情况，且打孔直径≤3cm），该检测项将标记为“改装损伤”，存在改装损伤的车辆不定义为重大事故车，因改装进行过切割、焊接或改装部位发生变形、撕裂（包括打孔后孔眼撕裂）的，按照具体部位的对应标准执行。<br>注：不同部件/部位存在缺陷需要描述程度时，不同的部件/部位对“严重”的概念将予以单独标注，未予描述的则不区分缺陷的程度。</div>
  <img src="/shigu.jpg"/>`,
  body: `<div class="content">1、本合同所指的“重大事故车”是指车辆结构部件受到一定程度的损伤且经过修复仍旧不能恢复全部性能的车辆的总称，具体判定规则标准如下：<br>2、事故车判定规则：<br>（1）车身结构部件检测项存在严重变形、严重钣金、切割、焊接、更换等维修经历或对应维修手段（指钣金、切割、焊接、更换）遗留的维修痕迹时，判定车辆存在事故风险；<br>（2）下表中任一检测项存在对应缺陷结果栏中的任何一项缺陷时，即判定为“重大事故车”，但“改装损伤”除外；<br>（3）针对车身结构件因改装发生状态改变的情况（仅限于改装打孔情况，且打孔直径≤3cm），该检测项将标记为“改装损伤”，存在改装损伤的车辆不定义为重大事故车，因改装进行过切割、焊接或改装部位发生变形、撕裂（包括打孔后孔眼撕裂）的，按照具体部位的对应标准执行。<br>注：不同部件/部位存在缺陷需要描述程度时，不同的部件/部位对“严重”的概念将予以单独标注，未予描述的则不区分缺陷的程度。</div>
  <img src="/shigu.jpg"/>`,
  inside: `<div class="content">1、本合同所指的“重大事故车”是指车辆结构部件受到一定程度的损伤且经过修复仍旧不能恢复全部性能的车辆的总称，具体判定规则标准如下：<br>2、事故车判定规则：<br>（1）车身结构部件检测项存在严重变形、严重钣金、切割、焊接、更换等维修经历或对应维修手段（指钣金、切割、焊接、更换）遗留的维修痕迹时，判定车辆存在事故风险；<br>（2）下表中任一检测项存在对应缺陷结果栏中的任何一项缺陷时，即判定为“重大事故车”，但“改装损伤”除外；<br>（3）针对车身结构件因改装发生状态改变的情况（仅限于改装打孔情况，且打孔直径≤3cm），该检测项将标记为“改装损伤”，存在改装损伤的车辆不定义为重大事故车，因改装进行过切割、焊接或改装部位发生变形、撕裂（包括打孔后孔眼撕裂）的，按照具体部位的对应标准执行。<br>注：不同部件/部位存在缺陷需要描述程度时，不同的部件/部位对“严重”的概念将予以单独标注，未予描述的则不区分缺陷的程度。</div>
  <img src="/shigu.jpg"/>`,
  cabin: `<div class="content">1、本合同所指的“重大事故车”是指车辆结构部件受到一定程度的损伤且经过修复仍旧不能恢复全部性能的车辆的总称，具体判定规则标准如下：<br>2、事故车判定规则：<br>（1）车身结构部件检测项存在严重变形、严重钣金、切割、焊接、更换等维修经历或对应维修手段（指钣金、切割、焊接、更换）遗留的维修痕迹时，判定车辆存在事故风险；<br>（2）下表中任一检测项存在对应缺陷结果栏中的任何一项缺陷时，即判定为“重大事故车”，但“改装损伤”除外；<br>（3）针对车身结构件因改装发生状态改变的情况（仅限于改装打孔情况，且打孔直径≤3cm），该检测项将标记为“改装损伤”，存在改装损伤的车辆不定义为重大事故车，因改装进行过切割、焊接或改装部位发生变形、撕裂（包括打孔后孔眼撕裂）的，按照具体部位的对应标准执行。<br>注：不同部件/部位存在缺陷需要描述程度时，不同的部件/部位对“严重”的概念将予以单独标注，未予描述的则不区分缺陷的程度。</div>
  <img src="/shigu.jpg"/>`,
}
